...
while run:
    ...
    if not finish:
        ...
        if sprite.spritecollide(player, aliens, False) or lost >= 3:
            finish = True
            lose = font1.render('        !', True, (200, 0, 0))
            window.blit(lose, (200, 200))
        
        if score >= 40:
            finish = True
            win = font1.render('      !', True, (0, 200, 0))
            window.blit(win, (200, 200))

        text_lose = font1.render('         :'+ str(lost), 1, (255, 255, 255) )
        text_score = font1.render('    :'+ str(score), 1, (255, 255, 255) )
